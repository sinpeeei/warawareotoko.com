...
Netflixが日本上陸してから早速使っているわけですけど、それと同時に色んな配信サイトの使い勝手を比較するために使ってみてます。その中のひとつに楽天が提供する配信サービス「楽天SHOWTIME」を見ていたら、ぼくの大好きなディスカバリーチャンネルの「サバイバルゲーム」という番組が配信されていました！！！ということで本日はそのご紹介<!--more-->
## サバイバルゲームとは？
